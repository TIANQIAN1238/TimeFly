...
# One-button release script for TimeFly.
...
PLIST=${PLIST:-"$REPO_ROOT/TimeFly/TimeFly/Info.plist"}
...
PBP="$REPO_ROOT/TimeFly/TimeFly.xcodeproj/project.pbxproj"
...
echo "Feed URL should be reachable at: https://timefly.so/appcast.xml"
