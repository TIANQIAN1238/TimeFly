...
struct OnboardingFlow: View {
    ...
    private let fullText = "Your day has a story. Uncover it with TimeFly."
    ...
    private func advance() {
        ...
        case .llmSelection:
            markStepCompleted(step)
            let nextStep: Step = (selectedProvider == "timefly") ? .categories : .llmSetup
            setStep(nextStep)
        case .llmSetup:
            markStepCompleted(step)
            step.next()
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Welcome to TimeFly! Let it run for about 30 minutes to gather enough data, then come back to explore your personalized timeline. If you have any issues, feature requests, or feedback please use the feedback tab. I would love to hear from you! ")
            ...
            ReferralSurveyView(
                prompt: "I have a small favor to ask. I'd love to understand where you first heard about TimeFly.",
