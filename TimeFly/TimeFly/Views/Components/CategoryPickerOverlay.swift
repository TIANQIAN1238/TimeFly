...
struct CategoryPickerOverlay: View {
    ...
    private var helperContent: some View {
        ...
        let linkURL = URL(string: "timefly://category-editor")!

        var intro = AttributedString("To help TimeFly organize your activities more accurately, try adding more details to the descriptions in your categories ")
        intro.font = baseFont
