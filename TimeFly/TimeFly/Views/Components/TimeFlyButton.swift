...
//  TimeFly
//
//  Custom button component with TimeFly branding
//

import SwiftUI
import AppKit

struct TimeFlyButton: View {
    let title: String
    let action: () -> Void
...
struct TimeFlyButton_Previews: PreviewProvider {
    static var previews: some View {
        VStack(spacing: 20) {
            TimeFlyButton(title: "Start", action: {})
            TimeFlyButton(title: "Continue", action: {}, width: 200)
            TimeFlyButton(title: "Next", action: {}, width: 120, fontSize: 14)
            TimeFlyButton(title: "Subtle", action: {}, isSubtle: true)
        }
        .padding(40)
