    ...
    private var displayView: some View {
        HStack(alignment: .center, spacing: 12) {
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text(category.details.isEmpty ? "Add a description to help TimeFly understand your workflow." : category.details)
                    .font(Font.custom("Nunito", size: 12).weight(.medium))
...
struct ColorOrganizerRoot: View {
        ...
        VStack(alignment: .leading, spacing: showTitles ? 20 : 16) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                instructionRow(
                    ...
                    text: "TimeFly organizes your activities by the category titles and descriptions you provide."
                )
                .frame(maxWidth: isCompact ? .infinity : 280, alignment: .leading)

                instructionRow(
                    icon: "CategoriesTextSelect",
                    text: "Try to provide as much details in the descriptions as you can to help TimeFly understand your workflow and habits."
                )
                .frame(maxWidth: isCompact ? .infinity : 280, alignment: .leading)
            }

            Text("This step is optional. You can customize the categories or create new ones anytime while using TimeFly.")
                .font(Font.custom("Nunito", size: 12).weight(.medium))
    ...
    private func colorAssignmentPanel(isCompact: Bool) -> some View {
        ...
        return VStack(alignment: .leading, spacing: 16) {
            ...
            Text("This step is optional. You can change the colors anytime while using TimeFly.")
                .font(Font.custom("Nunito", size: 12).weight(.medium))
                .foregroundColor(Color(red: 0.48, green: 0.48, blue: 0.48))
                .frame(maxWidth: .infinity, alignment: .leading)
...
// App entry point intentionally omitted; TimeFlyApp provides the main entry.
