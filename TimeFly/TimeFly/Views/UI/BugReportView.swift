...
struct BugReportView: View {
    ...
    var body: some View {
        VStack(spacing: 36) {
            VStack(spacing: 16) {
                Text("Thanks for using TimeFly")
                    .font(.custom("InstrumentSerif-Regular", size: 40))
                    .foregroundColor(.black.opacity(0.9))

                Text("Email works great if you want to drop a quick note, Discord if you want to join the community, and if you’d prefer to chat, find some time on my calendar - I’d love to dig into why TimeFly is or isn’t working well for you.")
    ...
    private func composeEmail() {
        ...
        components.queryItems = [
            URLQueryItem(name: "subject", value: "TimeFly feedback")
        ]
