...
struct JournalView: View {
    ...
    var lockScreen: some View {
        VStack(spacing: 24) {
            ...
            // Header: "TimeFly Journal" with BETA badge
            HStack(alignment: .top, spacing: 4) {
                Text("TimeFly Journal")
...
private struct JournalOnboardingView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            // Description
            Text("TimeFly helps you track your daily and longer term goals, gives you the space to reflect, and generates a summary of each day.")
