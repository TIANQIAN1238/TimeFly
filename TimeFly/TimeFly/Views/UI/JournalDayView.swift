...
private struct ReflectionPromptCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Return near the end of your day to reflect on your intentions. Let TimeFly generate a narrative summary based on the activities on your Timeline.")
                .font(.custom("Nunito-Regular", size: 15))
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack {
                ...
                if isLoading {
                    ...
                    Button("Summarize with TimeFly", action: onSummarize)
...
private struct IntroView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("TimeFly helps you track your daily and longer term pursuits, gives you the space to reflect, and generates a summary of each day.")
