...
struct ChatView: View {
    ...
    private var betaLockScreen: some View {
        VStack(spacing: 16) {
            ...
            VStack(spacing: 6) {
                Text("We're beta testing an early version of Dashboard. It's a chat feature that intelligently pulls from your TimeFly data to generate insights. You can ask it to generate charts and other visualizations of your data.")
            ...
            VStack(spacing: 16) {
                ...
                VStack(spacing: 12) {
                    ...
                    if cliDetected {
                        ...
                        Text("It's currently only available to users using Claude or Codex CLI to power TimeFly.")
