...
struct TimelineFeedbackModal: View {
    ...
    private let placeholder = "I don’t have access to your timeline (privacy first!), so your feedback here helps improve the quality of TimeFly for everyone."
    ...
    private var thanksContent: some View {
        VStack(spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                Text("If you find that your activities are summarized inaccurately, try editing the descriptions of your categories to improve TimeFly’s accuracy.")
                    .font(Font.custom("Nunito", size: 12).weight(.medium))
                    .foregroundColor(Color(hex: "333333"))
