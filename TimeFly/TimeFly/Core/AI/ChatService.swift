...
final class ChatService: ObservableObject {
    ...
    private func buildSystemPrompt() -> String {
        ...
        let dbPath = NSHomeDirectory() + "/Library/Application Support/TimeFly/chunks.sqlite"

        return """
        You are a friendly assistant in TimeFly, a macOS app that tracks computer activity.
        ...
        **observations** - Low-level granular snapshots (for deeper analysis)
        ...
        BAD example:
        "Morning focus started with a 9:20–10:04 work block researching TimeFly/ChatCLI logging and UX notes, then shifted into about an hour of personal/break time watching League clips, YouTube Shorts..."
...
extension ChatService {
    ...
    static var isProviderConfigured: Bool {
        ...
        if let _ = KeychainManager.shared.retrieve(for: "timefly"), !KeychainManager.shared.retrieve(for: "timefly")!.isEmpty {
            return true
        }
