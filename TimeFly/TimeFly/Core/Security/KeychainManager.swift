...
final class KeychainManager {
    ...
    private let servicePrefix = "com.teleportlabs.timefly.apikeys"
    private let queue = DispatchQueue(label: "com.teleportlabs.timefly.keychain", qos: .userInitiated)
    ...
    ///   - provider: The provider identifier (e.g., "gemini", "timefly")
