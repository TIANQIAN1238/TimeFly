...
final class LaunchAtLoginManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.timefly.app", category: "launch_at_login")
    ...
    /// Re-sync with System Settings, e.g. if the user adds/removes TimeFly manually.
